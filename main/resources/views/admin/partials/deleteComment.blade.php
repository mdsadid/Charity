<div class="modal-onboarding modal fade animate__animated" id="commentDeleteModal" tabindex="-1" aria-hidden="true">
    ...
    <script>
        (function($) {
            ...
            $('.commentDeleteButton').on('click', function() {
                ...
                let deleteModal = $('#commentDeleteModal')

                deleteModal.find('.question').text(question)
