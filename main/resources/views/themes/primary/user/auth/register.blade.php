            ...
            <div class="row justify-content-md-between justify-content-center align-items-center">
                <div class="col-xl-6 col-lg-5 col-md-4">
                    <div class="account-thumb">
                        <img src="{{ getImage('assets/images/site/register/' . @$registerContent->data_info->image, '635x645') }}" alt="register">
                    </div>
                </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <span class="password-show-hide fa-regular fa-eye toggle-password" id="#your-password"></span>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <span class="password-show-hide fa-regular fa-eye toggle-password" id="#confirm-password"></span>
                                    </div>
                                </div>
