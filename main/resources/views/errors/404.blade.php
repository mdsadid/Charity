    ...
    <body>
        <div class="container-xxl container-p-y">
            <div class="misc-wrapper">
                <h2 class="mb-2 mx-2">@lang('404, Page Not Found!')</h2>
                <p class="mb-4 mx-2">@lang('Oops!') 😖 @lang('The requested URL was not found on this server.')</p>
                <a href="{{ route('home') }}" class="btn btn-primary">@lang('Back to Home')</a>
                <div class="mt-4">
                    <img src="{{ asset('assets/admin/images/error.png') }}" alt="page-misc-error-light" width="500" class="img-fluid">
                </div>
            </div>
        </div>
    <body>
